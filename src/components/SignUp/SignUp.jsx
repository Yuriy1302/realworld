  ...
  return (
    <div className="create-new-accaunt">
      <form action="" className="form-create" onSubmit={handleSubmit(onSignUp)}>
        ...
        {serverErrors && "username" in serverErrors && (
          <span className="text-danger">
            {serverErrors.username[0][0].toUpperCase() +
              serverErrors.username[0].slice(1)}
          </span>
        )}
        ...
        {serverErrors && "email" in serverErrors && (
          <span className="text-danger">
            {serverErrors.email[0][0].toUpperCase() +
              serverErrors.email[0].slice(1)}
          </span>
        )}
